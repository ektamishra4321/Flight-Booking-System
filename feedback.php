...
$sql="INSERT INTO `feedback`.`feedback`( `name`, `email`,`mobile`,`category`, `feedback`) VALUES ( '$name', '$email','$mobile','$category', '$feedback');";
...
<h2 style="margin-left:210px;">Feedback</h2>
  <form action="feedback.php" method="post" name="frm">
    ...
    <select id="cou" name="category" required>
    ...
    <textarea id="feedback" name="feedback" placeholder="Give your feedback" style="height:190px"></textarea>

    <input type="submit" value="Submit"  onclick="ValidateEmail(document.frm.email)" ><br><br><br>
    <a href="home_log.php"><input type="button" value="Home Page"></a>
  </form>
</div>
<script>
