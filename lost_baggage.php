...
p.one
    ...
    body
    {
        background-color: rgb(74, 133, 199);
    }
    label
    {
        color: white;
...
border: 3px solid rgb(107, 94, 94);

padding: 20px;

background-color:rgb(152, 196, 211);
...
<form name="frm" action="lost_baggage.php" method="post">
    ...
    <input type="submit" onclick="ValidateEmail(document.frm.email)" value="Submit" class="submit"><br><br>
    
</form>
</td>
<td>
<div align="center" class="div"> Lost Baggage  </div>
</td>
</tr>
</table>
...
<br>
<button class="button"><a href="first_page.php" target="first_page.php"><font style="color:black">GO BACK</font></a></button>
