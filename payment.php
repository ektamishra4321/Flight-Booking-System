...
$sql="INSERT INTO `payment`.`payment`(`name`, `email`, `phone`, `address`, `passport`, `DOB`, `ccnum`) VALUES ('$name', '$email', '$phone', '$address', '$passport', '$DOB', '$ccnum');";
...
<div class="row">
  <div class="col-75">
    <div class="container">
      <form action="payment.php" name="RegForm" onsubmit="return validate()"  method="post" required>
...
<div>
             ...
             <input type="button" onclick="window.location.href = 'otp.html';" class="button" value="Seat Booking">

            <label for="ccnum">Credit card number</label>
            <input type="text" id="ccnum" name="ccnum" placeholder="1111-2222-3333-4444">

            <label for="ccnum">Payment Amount</label>
            <input type="text" id="amt" value="2500" readonly>
